<div class="modal-header ">
    <center>
        <h4 class="modal-title green">UỶ NHIỆM CHI</h4>
    </center>
</div>
<form action="" method="POST" data-path="{{ route('standing-order.store') }}" role="form" enctype="multipart/form-data" id="add_payment_voucher_form" class="row" >
    <div class="modal-body">
        <div class="col-md-10 row">
            <div class="form-group col-md-12">
                <label for="">Tài khoản đối tượng trả tiền</label>
            ...
            <div class="form-group col-md-6">
                <label for="">Tài khoản người nhận</label>
                <input name="account_to" type="text" class="form-control" id="account_to" >
            </div>
