...
<!-- BEGIN LOGO -->
      ...
      <div class="content">
        ...
        <form id="form-login" action="{{ url('/login') }}" method="POST" role="form">
            ...
            <div class="svgContainer">
                <div>
                    <svg class="mySVG" viewBox="0 0 200 200">
                        ...
                        <circle cx="100" cy="100" r="100" fill="#fb7e03"/>
                        <g class="body">
            ...
            <div class="form-group inputGroup inputGroup1">
                <label class="control-label visible-ie8 visible-ie9">Email</label>
                <input class="form-control form-control-solid placeholder-no-fix email" type="text" id="email" placeholder="Nhập email" name="email" value="{{old('email')}}" />
            ...
            <div class="form-group inputGroup inputGroup2">
                <label class="control-label visible-ie8 visible-ie9">Mật khẩu</label>
                <input class="form-control form-control-solid placeholder-no-fix password" type="password" id="password" placeholder="Nhập mật khẩu" name="password" />
            ...
            <div class="form-actions">
                <button type="submit" class="btn green uppercase" style="background-color: #fb7e03">Đăng Nhập</button>
                <label class="rememberme check">
                    <input type="checkbox" name="remember" value="1" />Ghi nhớ</label>
              <a href="{{ route('forgot-password')}}" id="forget-password" class="forget-password" style="color: #fb7e03">Quên mật khẩu?</a>
            </div>
        </form>
        </div>
</div>
