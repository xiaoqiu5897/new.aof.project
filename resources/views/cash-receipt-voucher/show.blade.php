        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                <div class="pull-right text-center">
                    <div><span>Mẫu số : 01  - TT</span></div>
                    <div>
                        <span>(Ban hành theo Thông tư số: 200/2014/QĐ-BTC</span>
                        <br>
                        <span>Ngày 20/03/2006 của Bộ trưởng BTC)</span>
                    </div>
                </div>
            </div>
            <div class="col-xs-12">
                <div class="text-center">
                    <h3 class="uppercase bold">Phiếu Thu</h3>
            ...
            <div class="col-xs-12">
                <div class="parent_border_dashed mg-bot-20">
                    <span class="title_hide_dashed">Họ và tên người nộp tiền : </span>
                ...
                <div class="parent_border_dashed mg-bot-20">
                    <span class="title_hide_dashed">Lý do nộp : </span>
            ...
            <div class="col-xs-12" style="height: 100px">
                <div class="row">
                    ...
                    <div class="col-xs-2">
                        <div class="text-center">
                            <div><span>Người nộp tiền</span></div>
                            <div><span>(Ký, họ tên)</span></div>
                        </div>
                    </div>
                    <div class="col-xs-2">
